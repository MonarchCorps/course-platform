// import { HEIGHT, MIN_LEDGE, Side, WIDTH } from '@/constants'
// import { WaveProps } from '@/types/Wave'
// import { View, Text, Platform } from 'react-native'
// import Animated, { useAnimatedProps, useAnimatedStyle, useDerivedValue, withSpring, withTiming } from 'react-native-reanimated'
// import Svg, { Path } from 'react-native-svg'
// import MaskedView from "@react-native-community/masked-view"

// const AnimatedPath = Animated.createAnimatedComponent(Path)

// function Wave({ side, position, isTransitioning, children }: WaveProps) {
...
//                 {maskElement}
//                 <Animated.View className={`absolute inset-0`} style={[androidStyle]}>
//                     {children}
//                 </Animated.View>
//             </View>
//         );
...
//     return (
//         // @ts-ignore
//         <MaskedView className={`absolute inset-0`} maskElement={maskElement}>
//             {children}
//         </MaskedView>
//     );
// }
